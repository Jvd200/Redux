...
const combineReducers =redux.combineReducers  //meltipale reducer
const reduxLogger=require('redux-logger')
const logger=reduxLogger.createLogger()  //create Logger middleware
const applyMiddleware=redux.applyMiddleware //apply logger middle there is no console log statememnt needed
...
const store=createStore(rootReducer, applyMiddleware(logger))// reduser takes initial state and store in a variable
